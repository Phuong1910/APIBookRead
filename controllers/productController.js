    ...
    async  function createProduct(req, res) {
        try {
            ...
            let { title, author , description, descriptionNhanVat, descriptionCauNoi } = JSON.parse(body)
            const product = {
                title,
                author,
                description,
    ...
    async  function updateProduct(req, res, id) {
        try {
            ...
            if (!product) {
                ...
                const body = await getPostData(req)
            const { title, author,  description, descriptionNhanVat, descriptionCauNoi } = JSON.parse(body)
            const productData = {
